...
namespace PluginTaskBalTeplo
{
    public class TaskBalTeploCalculate : TepCommon.HandlerDbTaskCalculate
    {
        ...
        public void CreateSession(int cntBasePeriod
            , DataTable tablePars
        ...
        public partial class TaskBalTeploCalculate : TepCommon.HandlerDbTaskCalculate.TaskCalculate
        {
            ...
            private float calculateOut(string nAlg)
            {
                ...
                switch (nAlg)
                {
                    ...
                    #region 3.1
                    case @"3.1": //Тепло по блокам с подпиткой
                        for (i = (int)INDX_COMP.iST; i < (int)INDX_COMP.UNKNOWN; i++)
                        {
                            double str = 0;
                    ...
                    #region 3.3
                    case @"3.3": //Тепло с подпиткой сумма суммы тепла по блокам и тепла с подпиткой теплосети
                        for (i = (int)INDX_COMP.iST; i < (int)INDX_COMP.UNKNOWN; i++)
                        {
                            double str = 0;
