    ...
    public partial class HandlerDbTaskCalculate : TepCommon.HandlerDbValues
    {
        ...
        public partial class TaskTepCalculate : TepCommon.HandlerDbTaskCalculate.TaskCalculate
        {
            ...
            private int calculateNormative()
            {
                ...
                /*-------------24 - dqт бр(ном) -------------*/
                Norm[@"24"][ST].value = calculateNormative(@"24");
                /*-------------25 - W т/тф(ном)-------------*/
                calculateNormative(@"25");

                //Изменение прямого порядка вычисления
                /*-------------49 - D пе -------------*/
                Norm[@"49"][ST].value = calculateNormative(@"49");
                /*-------------50 - D пе -------------*/
                Norm[@"50"][ST].value = calculateNormative(@"50");
                /*-------------51 - t пе -------------*/
                ...
                /*-------------28 N кн (ном)-------------*/
                Norm[@"28"][ST].value = calculateNormative(@"28");
                /*-------------29 N цн (н) гр-------------*/
                Norm[@"29"][ST].value = calculateNormative(@"29");
                /*-------------30 N кэн (н)-------------*/
                calculateNormative(@"30");
                /*-------------31 N бл(н)т-------------*/
                calculateNormative(@"31");
                /*-------------32 N ст(н)т гр-------------*/
                Norm[@"32"][ST].value = calculateNormative(@"32");
                /*-------------33 -------------*/
                /*-------------34 -------------*/
                /*-------------35 Э т сн(пуск)-------------*/
                Norm[@"35"][ST].value = calculateNormative(@"35");
                /*-------------36 Э т сн/(ном)-------------*/
                Norm[@"36"][ST].value = calculateNormative(@"36");
                /*-------------37 Э цн (ном) гр-------------*/
                Norm[@"37"][ST].value = calculateNormative(@"37");
                /*-------------38 Q т.о(отопл)-------------*/
                Norm[@"38"][ST].value = calculateNormative(@"38");
                /*-------------39 Q т.о(вент)-------------*/
                Norm[@"39"][ST].value = calculateNormative(@"39");
                /*-------------40 Q т сн(пуск)-------------*/
                Norm[@"40"][ST].value = calculateNormative(@"40");
                /*-------------41 q т сн(ном)-------------*/
                Norm[@"41"][ST].value = calculateNormative(@"41");
                /*-------------42 q т н (ном)-------------*/
                Norm[@"42"][ST].value = calculateNormative(@"42");
                /*-------------43 k по-------------*/
                calculateNormative(@"43");
                /*-------------44 k то-------------*/
                calculateNormative(@"44");
                /*-------------45 dQ э по-------------*/
                Norm[@"45"][ST].value = calculateNormative(@"45");
                /*-------------46 dQ э то-------------*/
                Norm[@"46"][ST].value = calculateNormative(@"46");
                /*-------------47 dQ э-------------*/
                Norm[@"47"][ST].value = calculateNormative(@"47");
                /*-------------48 k отр (т)-------------*/
                Norm[@"48"][ST].value = calculateNormative(@"48");

                //Изменение прямого порядка вычисления
                /*-------------66 D пв-------------*/
                Norm[@"66"][ST].value = calculateNormative(@"66");
                /*-------------66.1 D пв ср-------------*/
                Norm[@"66.1"][ST].value = calculateNormative(@"66.1");
                /*-------------67 alfa вэк (н)-------------*/
                calculateNormative(@"67");
                /*-------------68 dalfa ух (н)-------------*/
                calculateNormative(@"68");
                /*-------------69 alfa yx (н)-------------*/
                calculateNormative(@"69");
                /*-------------70 q 4 исх-------------*/
                calculateNormative(@"70");
                /*-------------71 dq 4 (Ap)-------------*/
                calculateNormative(@"71");
                /*-------------72 dq 4 (Wp)-------------*/
                calculateNormative(@"72");
                /*-------------73 q 4 (н)-------------*/
                Norm[@"73"][ST].value = calculateNormative(@"73");
                /*-------------74 t пв (н)-------------*/
                Norm[@"74"][ST].value = calculateNormative(@"74");
                /*-------------75 t yx исх-------------*/
                calculateNormative(@"75");
                /*-------------76 dt yx (t пв)-------------*/
                calculateNormative(@"76");
                /*-------------77 dt yx (t вп)-------------*/
                calculateNormative(@"77");
                /*-------------78 dt yx (t рец)-------------*/
                calculateNormative(@"78");
                /*-------------79 t yx (н)-------------*/
                Norm[@"79"][ST].value = calculateNormative(@"79");
                /*-------------80 k-------------*/
                calculateNormative(@"80");
                /*-------------81 c-------------*/
                calculateNormative(@"81");
                /*-------------82 b-------------*/
                calculateNormative(@"82");
                /*-------------83 q 2 (н)-------------*/
                Norm[@"83"][ST].value = calculateNormative(@"83");
                /*-------------84 q 5 (н)-------------*/
                calculateNormative(@"84");
                /*-------------85 q 6 (н)-------------*/
                calculateNormative(@"85");
                /*-------------86 q pec (н)-------------*/
                calculateNormative(@"86");
                /*-------------87 q пуск (н)-------------*/
                calculateNormative(@"87");
                /*-------------88 КПД к бр (ном)-------------*/
                Norm[@"88"][ST].value = calculateNormative(@"88");
                /*-------------89 alfa уг-------------*/
                calculateNormative(@"89");
                /*-------------90 В нат (ном)-------------*/
                Norm[@"90"][ST].value = calculateNormative(@"90");
                /*-------------91-------------*/
                /*-------------92-------------*/
                /*-------------93-------------*/
                /*-------------94-------------*/
