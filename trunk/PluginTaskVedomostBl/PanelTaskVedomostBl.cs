...
namespace PluginTaskVedomostBl
{
    public partial class PanelTaskVedomostBl : HPanelTepCommon
    {
        ...
        protected static List<List<string>> s_listGroupHeaders = new List<List<string>> {
            // группа №1
            new List<string> { /*1.1*/ "Острый пар", /*1.2*/"Горячий промперегрев", /*1.3*/"ХПП" }
            // группа №2
            , new List<string> { /*2.1*/"Питательная вода", /*2.2*/"Продувка", /*2.3*/"Конденсатор", /*2.4*/"Холодный воздух", /*2.5*/"Горячий воздух", /*2.6*/"Кислород", /*2.7*/"VI отбор", /*2.8*/"VII отбор" }
            // группа №3
            , new List<string> { /*3.1*/"Уходящие газы", /*3.2*/"", /*3.3*/"", /*3.4*/"", /*3.5*/"РОУ", /*3.6*/"Сетевая вода", /*3.7*/"Выхлоп ЦНД" }
        };
        /// <summary>
        /// Набор элементов
        /// </summary>
